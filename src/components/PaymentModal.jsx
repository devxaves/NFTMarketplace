...
function PaymentModal(props) {
  ...
  async function sendFund() {
    ...
    try {
      ...
      await txn.wait();
      alert(`${amount} LineaETH Succesfully funded`);
    ...
    <div className="modal">
      ...
      <div className="modalContent">
        <div className="paymentForm">
          <label className="paymentLabel">Amount (LineaETH)</label>
          <input
            type="number"
            name="payment"
            id="payment"
            className="payment"
            placeholder="Enter LineaETH amount"
            min="1"
            step="1"
            value={amount}
